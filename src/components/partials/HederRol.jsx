...
* */
  ...
  const mainListItems = (
    <React.Fragment>
      ...
      <ListItemButton onClick={() => navigate("/admin/tabla/shows")}>
        <ListItemIcon>
        <TheaterComedyIcon/>
        </ListItemIcon>
        <ListItemText primary="Shows" />
      </ListItemButton>
      <ListItemButton onClick={() => navigate("/admin/tabla/jefesalas")}>
        <ListItemIcon>
        <SupervisorAccountIcon/>
        </ListItemIcon>
        <ListItemText primary="Jefes De Sala" />
      </ListItemButton>
      <ListItemButton onClick={() => navigate("/admin/tabla/pedidos")}>
        <ListItemIcon>
          <AssignmentIcon />
        </ListItemIcon>
